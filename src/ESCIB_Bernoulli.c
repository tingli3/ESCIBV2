...
//	printf("Index blocks: %d * %d\n", nBlockX, nBlockY);
	...
	int * clusters = doClusterBer(x, y, ind, index, nBlockX, nBlockY, radius, xMin, yMin, countCas, countCon, countPointsCas, countPointsCon, p, significance, minCore, nonCorePoints);
	//Output 
